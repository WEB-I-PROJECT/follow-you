...
function actionDetails(event) {
    ...
    fetch(`http://localhost:8001/categoria/details/${idCategory}`).then((response) => {
        ...
        card.innerHTML = `
            ...
            <div class="actions">
                <button class="btn btn-warning" data-bs-toggle="modal" onclick="editCategory(event)" data-bs-target="#ModalEditCategory" data-bs-whatever="${idCategory}"><i class="bi bi-pencil-fill" style="color: white;"></i></button>
